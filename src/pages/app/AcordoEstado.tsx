...
export function AcordoEstado() {
    return (
        <>
            <Helmet title="Acordo de Reparação - Estado" />
            <div className='h-screen flex flex-col'>
                <h1 className="text-3xl text-sky-800 font-bold mb-8 text-center">ACORDO DE REPARAÇÃO - ESTADO</h1>
